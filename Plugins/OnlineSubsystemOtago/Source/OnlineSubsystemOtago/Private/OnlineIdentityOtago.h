...
public:
	...
	// FUserOnlineAccountOtago

	FUserOnlineAccountOtago(const FString& InUserId = TEXT(""))
		: UserIdPtr(new FUniqueNetIdString(InUserId))
	{}

	virtual ~FUserOnlineAccountOtago()
	{
	}
...
/**
* Otago service implementation of the online identity interface
*/
class FOnlineIdentityOtago : public IOnlineIdentity
{
public:
	...
	*/
	FOnlineIdentityOtago(class FOnlineSubsystemOtago* InSubsystem);

	/**
	* Destructor
	*/
	virtual ~FOnlineIdentityOtago();
...
private:
	...
	*/
	FOnlineIdentityOtago() = delete;

	/** Cached pointer to owning subsystem */
	FOnlineSubsystemOtago* OtagoSubsystem;

	/** Ids mapped to locally registered users */
	TMap<int32, TSharedPtr<const FUniqueNetId>> UserIds;

	/** Ids mapped to locally registered users */
	TMap<FUniqueNetIdString, TSharedRef<FUserOnlineAccountOtago>> UserAccounts;
};

typedef TSharedPtr<FOnlineIdentityOtago, ESPMode::ThreadSafe> FOnlineIdentityOtagoPtr;
